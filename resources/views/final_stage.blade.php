          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <p class="custom_error">{{$errors->first('agree')}}</p>
                  ...
                  <?php } ?>
                  <form id="register-form" action="{{action('RegisterController@finished')}}" method="post">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          <label for="agree" class="label-material">{{ trans('app_lang.agree_terms') }}</label><br />
                          <input id="agree" type="checkbox" name="agree" required="required" class="checkbox-template">
                    ...
                    <div class="row">
                      <div class="col-lg-5">
                        <div class="form-group">
                          <input id="proceed" type="submit" value="Finish" class="btn btn-primary">
                        </div>
                      </div>
                    </div>
                  </form>
